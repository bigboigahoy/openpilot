...
protected:
  ...
  inline QColor redColor(int alpha = 255) { return QColor(243, 139, 168, alpha); }
  inline QColor whiteColor(int alpha = 255) { return QColor(205, 214, 244, alpha); }
  inline QColor blackColor(int alpha = 255) { return QColor(17, 17, 27, alpha); }
