...
const QColor bg_colors [] = {
  [STATUS_DISENGAGED] = QColor(0x18, 0x18, 0x25, 0xc8),
  [STATUS_OVERRIDE] = QColor(0x93, 0x99, 0xb2, 0xf1),
  [STATUS_ENGAGED] = QColor(0xa6, 0xe3, 0xa1, 0xf1),

  // FrogPilot colors
  [STATUS_ALWAYS_ON_LATERAL_ACTIVE] = QColor(0x74, 0xc7, 0xec, 0xf1),
  [STATUS_CONDITIONAL_OVERRIDDEN] = QColor(0xf9, 0xe2, 0xaf, 0xf1),
  [STATUS_EXPERIMENTAL_MODE_ENABLED] = QColor(0xfa, 0xb3, 0x87, 0xf1),
  [STATUS_NAVIGATION_ACTIVE] = QColor(0x89, 0xb4, 0xfa, 0xf1),
  [STATUS_TRAFFIC_MODE_ENABLED] = QColor(0xf3, 0x8b, 0xa8, 0xf1),
};
